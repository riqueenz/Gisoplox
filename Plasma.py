...
#Entradas adaptadas para plasma
    ...
    while pecasFeitas<pecas:
        if (pecasFeitas==0) or seq==1:
            ...
            #Gerar segunda peça
            programa=programa + "G00 X" + str(kerf+kerf) + " Y" + str(entrada) + '\n'
            programa=programa + icorte + '\n'
            programa=programa + "G01 X" + str(tx-kerf) + '\n'
            distCorte+=float(tx)
            programa=programa + "G01 Y" + str(tyf) + '\n'
            distCorte+=float(tyf)
            ...
            programa=programa + "G00 X" + str(mover+kerf) + " Y-" + str(tyf) + '\n'
            programa=programa + icorte + '\n'
            programa=programa + "G01 X" + str(tx-kerf) + '\n'
            distCorte+=float(tx)
            programa=programa + "G01 Y" + str(tyf) + '\n'
            ...
            if mx==2:
                ...
                programa=programa + "G00 X" + str(mover+kerf) + " Y-" + str(tyEkerf) + '\n'
            programa=programa + icorte + '\n'
            #distCorte+=float(icorte)
            programa=programa + "G01 X" + str(tx-kerf) + '\n'
            distCorte+=float(tx)
            ...
            if mx==1:
                if gy==0:
                    programa=programa + "G00 X-" + str(txf) + " Y" + str(tyf+kerf+entrada+kerf) + '\n'
                    gy+=2
                else:
                    programa=programa + "G00 X-" + str(txf-entrada) + " Y" + str(tyf+kerf+kerf) + '\n'
                    gy+=1
            else:
                mover1peca2linha=(txf*(mx-2))+kerf-entrada+txf
                programa=programa + "G00 X-" + str(mover1peca2linha) + " Y" + str(kerf+kerf) + '\n'
            programa=programa + icorte + '\n'
            programa=programa + "G01 Y" + str(ty-kerf) + '\n'
            distCorte+=float(ty)
            programa=programa + "G01 X" + str(txf) + '\n'
            distCorte+=float(txf)
            ...
            if mx==1:
                ...
                programa=programa + "G00 X" + str(mover) + " Y" + str(kerf) + '\n'
            ...
            programa=programa + fcorte + '\n'
            #distCorte+=float(fcorte)
            programa=programa + "G00 X" + str(mover2) + " Y-" + str(ty-kerf) + '\n'
...
#pula, prg, pula = Retangulo(txd, tyd, entrada, chapaX, chapaY, pecas, kerf)
#pula, prg, pula = Retangulo("100", "160", "5", "0", "0", "30", "2.3")
...
def Circulo(diam1, diam2, entrada, chapaX, chapaY, pecas, kerf):
    ...
    entradaInclinada=0.707106781186548*entrada
    entradaInclinada=round(entradaInclinada, 4)
    raioExtKerfInclinado=0.707106781186548*raioExtKerf
    raioExtKerfInclinado=round(raioExtKerfInclinado, 4)
    ...
    while pecasFeitas<pecas:
        if (pecasFeitas==0 and mov==0):
            ...
            programa=programa + "G00 X" + str(raioExtKerf+raioIntKerf-entradaKerf) + " Y" + str(raioExtKerf) + '\n'
            ...
            moverX=raioIntKerf-entradaKerf+raioExtKerfInclinado+entradaInclinada
            moverX=round(moverX, 4)
            moverY=raioExtKerfInclinado+entradaInclinada
            moverY=round(moverY, 4)

            programa=programa + "G00 X-" + str(moverX) + ' Y' + str(moverY) + '\n'
            programa=programa + str(icorte) + '\n'
            programa=programa + "G01 X" + str(entradaInclinada) + " Y-" + str(entradaInclinada) + '\n'
            distCorte+=calcularHipotenusa(entradaInclinada, entradaInclinada)
            programa=programa + "G03 X0.0000 Y0.0000 I" + str(raioExtKerfInclinado) + " J-" + str(raioExtKerfInclinado) + '\n'
            ...
            programa=programa + "G00 X" + str(moverX+raioExtKerf+raioExtKerf+kerf+kerf+kerf) + ' Y-' + str(moverY) + '\n'
            ...
            linhaX=((raioIntKerf-entrada+raioExtKerfInclinado+entradaInclinada)-((mx-1)*((2*raioExtKerf)+(3*kerf))))
            linhaX=round(linhaX, 4)
            linhaY=((2*raioExtKerf)+(3*kerf))-(raioExtKerfInclinado+entradaInclinada)
            linhaY=round(linhaY, 4)
            programa=programa + "G00 X" + str(linhaX) + " Y" + str(linhaY) + '\n'            
            mov=4
            ...
            if mx==1:
                ...
                linhaY=((2*raioExtKerf)+(3*kerf))-(raioExtKerfInclinado+entradaInclinada)
                linhaY=round(linhaY, 4)
                programa+="G00 X"+str(moverX) +"  Y"+str(linhaY)+"\n"
            else:
...
#pecasFeitas, prg, distCorte = Circulo("200", "100", "5", "0", "0", "36", "1.3")
#Auxiliares.escreverPrograma(prg, "/home/henrique/linuxcnc/nc_files/a.ngc")

#############################################################################################################################################
def CirculoSimples(diam1, entrada, chapaX, chapaY, pecas, kerf):
    #Adaptado para processo de corte à plasma
    #Garantir que as variaveis sao do tipo float
    diam1=float(diam1)
    diamExt=float(diam1)
    entrada=float(entrada)
    ...
    #Calculo de pecas por linha
    div=raioExtKerf+raioExtKerf+kerf+kerf+kerf
    mx=chapaX/div
    my=chapaY/div
    mx=int(mx)
    my=int(my)
    ...
    while pecasFeitas<pecas:
        if (pecasFeitas==0 and mov==0):
            #Gerar primeira peça
            #print "Gerar primeira peça"
            moverX=(0.292893218813452*raioExtKerf)-(entradaInclinada)
            moverY=(1.707106781186548*raioExtKerf)+(entradaInclinada)
            moverX=round(moverX, 4)
            moverY=round(moverY, 4)
            ...
            #Movimentar para a segunda peça
            programa=programa + "G00 X" + str(raioExtKerf+raioExtKerf+kerf+kerf+kerf) + '\n'
            mov=2
            if mx==2:
                seq=0
            ...
            programa=programa + 'G00 X0.0 Y' + str(raioExtKerf+raioExtKerf+kerf+kerf+kerf) + '\n'
            #programa+="teste\n"
            ...
            #Movimentar para a primeira peça das demais linhas
            #print "Movimentar para a primeira peça das demais linhas"
            programa=programa + "G00 X-" + str(((mx-1)*(raioExtKerf+raioExtKerf+kerf+kerf+kerf))) + " Y" + str(raioExtKerf+raioExtKerf+kerf+kerf+kerf) + '\n'
            mov=4
...
#pecasFeitas, prg, distCorte = CirculoSimples("100", "5", "530", "0", "125", "1.5")
#Auxiliares.escreverPrograma(prg, "/home/henrique/linuxcnc/nc_files/a.ngc")

#############################################################################################################################################
def TrianguloRetangulo(txd, tyd, entrada, chapaX, chapaY, pecas, kerf):
#Adaptado para processo corte à plasma
    #Garantir que as variaveis sao do tipo float
    txd=float(txd)
    tyd=float(tyd)
    entrada=float(entrada)
    ...
    while pecasFeitas<pecas:
        ...
        if (pecasFeitas==0):
            ...
            programa=programa + "G00 Y" + str(kerf) + '\n'
            programa=programa + icorte + '\n'
            programa=programa + "G01 Y" + str(tyf-kerf) + '\n'
            distCorte+=tyf
            programa=programa + "G01 X-" + str(txf) + '\n'
            distCorte+=txf
            programa=programa + fcorte + '\n'
            ...
            programa=programa + "G00 X" + str(kerf) + '\n'
            programa=programa + icorte + '\n'
            programa=programa + "G01 X" + str(txf-kerf) + '\n'
            distCorte+=txf
            programa=programa + "G01 X-" + str(txf) + " Y" + str(tyf) + '\n'
            distCorte+=calcularHipotenusa(txf, tyf)
...
#pecasFeitas, prg, distCorte = RetanguloFuro("246", "305", "120", "3", "1000", "0", "18", "1.5")
#Auxiliares.escreverPrograma(prg, "/home/henrique/linuxcnc/nc_files/a.ngc")
    ...
    while pecasFeitas<pecas:
        ...
        if (pecasFeitas==0):
            ...
            if direita==False:
                ...
                tan=chanfroX/mover
                tan=round(tan, 3)
                programa+= "G00 X-" + str(kerf*tan) + " Y" + str(kerf) + '\n'
                programa+= icorte + '\n'
                programa+= "G01 X-" + str(chanfroX-(kerf*tan)) + " Y" + str(mover-kerf) + '\n'
                ...
                if gx==1:
                    ...
                    programa+= "G00 X" + str(kerf) + '\n'
                    programa+= icorte + '\n'
                    programa+= "G01 X" + str(txf-kerf) + '\n'
                    distCorte+=txf
            ...
            if direita==True:
                programa+= "G00 X" + str(kerf) + '\n'
                programa=programa + icorte + '\n'
                programa+= "G01 X" + str(chanfroX-kerf) + '\n'
                distCorte+=chanfroX
                programa=programa + fcorte + '\n'
                ...
                tan=round(tan, 2)
                tanKerf=tan*kerf
                tanKerf=round(tanKerf, 3)

                programa+= "G00 X" + str(tanKerf) + " Y" + str(kerf) + '\n'
                programa+= icorte + '\n'
                
                programa+= "G01 X" + str(chanfroX-tanKerf) + " Y" + str(mover-kerf) + '\n'
                distCorte+=calcularHipotenusa(chanfroX, mover)
                programa+= "G01 Y" + str(chanfroY) + '\n'
                distCorte+=chanfroY
                programa+= "G01 X-" + str(txf) + '\n'
            ...
            programa+= "G00 Y" + str(kerf) + '\n'
            programa+= str(icorte) + '\n'
            programa+= "G01 Y" + str(tyf-kerf) + '\n'
            distCorte+=tyf
            programa+="G01 X" + str(chanfroX) + '\n'
            distCorte+=chanfroX
            programa+= "G01 X" + str((txf-chanfroX)) + " Y-" + str((tyf-chanfroY)) + '\n'
            ...
            if direita==False:
                programa+= "G00 Y" + str(kerf) + '\n'
                programa=programa + icorte + '\n'
                programa+= "G01 Y" + str(chanfroY-kerf) + '\n'
                distCorte+=chanfroY
                programa+= "G01 X-" + str((txf-chanfroX)) + " Y" + str((tyf-chanfroY)) + '\n'
                distCorte+=calcularHipotenusa((txf-chanfroX), (tyf-chanfroY))
                programa+= "G01 X-" + str(chanfroX) + '\n'
...
def RetanguloChanfrado(txd, tyd, chanfroXs, chanfroYs, chanfroXi, chanfroYi, entrada, chapaX, chapaY, pecas, kerf):
    ...
    #Offset entrada plasma
    def calcularOffset(kerf, kcxi, kcyi):
        offsetkcxi=float(kerf)*(float(kcxi)/calcularHipotenusa(kcxi, kcyi))
        offsetkcxi=("%.4f" % offsetkcxi)
        offsetkcyi=float(kerf)*(float(kcyi)/calcularHipotenusa(kcxi, kcyi))
        offsetkcyi=("%.4f" % offsetkcyi)
    ...
    while pecasFeitas<pecas:
        if (pecasFeitas==0) or seq==1:
            ...
            #Gerar segunda peça
            distX=float(kcxi)+float(offsetkcxi)
            distX=("%.4f" % distX)
            distY=float(entrada)+float(kcyi)-float(offsetkcyi)
            distY=("%.4f" % distY)
            programa=programa + "G00 X" + str(distX) + " Y" + str(distY) + '\n'
            programa=programa + icorte + '\n'
            distX=float(kcxi)-float(offsetkcxi)
            distX=("%.4f" % distX)
            distY=float(kcyi)-float(offsetkcyi)
            distY=("%.4f" % distY)
            programa=programa + "G01 X" + str(distX) + ' Y-' + str(distY) + '\n'
            distCorte+=calcularHipotenusa(distX, distY)
            programa=programa + "G01 X" + str(ktxi) + '\n'
            distCorte+=float(ktxi)
            programa=programa + "G01 X" + str(kcxi) + ' Y' + str(kcyi) + '\n'
            distCorte+=calcularHipotenusa(kcxi, kcyi)
            ...
            #Gerar demais peças da primeira linha
            distX=float(kcxs)+float(ktxs)+float(kcxs)+float(offsetkcxi)
            distX=("%.4f" % distX)
            distY=float(kty)-float(entrada)+float(offsetkcyi)
            distY=("%.4f" % distY)
            programa=programa + "G00 X" + str(distX) + " Y-" + str(distY) + '\n'
            programa=programa + icorte + '\n'
            distX=float(kcxi)-float(offsetkcxi)
            ...
            if linhaPar==False:
                ...
                nkcxi=("%.4f" % float(kcxi))
                nkcyi=("%.4f" % float(kcyi))
                offsetkcxi, offsetkcyi=calcularOffset(kerf, nkcxs, nkcys)
            if linhaPar==True:
                nktxs=("%.4f" % float(ktxi))
                nktxi=("%.4f" % float(ktxs))
                nkty=("%.4f" % float(kty))
                ...
                nkcxi=("%.4f" % float(kcxs))
                nkcyi=("%.4f" % float(kcys))
                offsetkcxi, offsetkcyi=calcularOffset(kerf, nkcxi, nkcyi)
                
            if mx==1:
                distX=float(nktxi)+float(nkcxi)-float(nkcxs)+float(offsetkcxi)-float(entrada)
                distX=("%.4f" % distX)
                distY=float(kcys)+float(kty)+float(kcyi)+float(offsetkcyi)
                distY=float("%.4f" % distY)
                
                if gy==1:
                    distX=float(nktxi)+float(nkcxi)-float(nkcxs)+float(offsetkcxi)
                    distY+=float(entrada)
                distY=("%.4f" % distY)
                programa=programa + "G00 X-" + str(distX) + " Y" + str(distY) + '\n'
            else:
                distX=float(kcxs)+float(ktxs)+float(kcxs)
                distX=(distX*(mx-2))+float(nkcxi)+float(nktxi)+float(offsetkcxi)
                distX=("%.4f" % distX)
                distY=float(nkcyi)+float(entrada)+float(offsetkcyi)
                distY=("%.4f" % distY)
                programa=programa + "G00 X-" + str(distX) + " Y" + str(distY) + '\n'
                print(distX, distY)
            programa=programa + icorte + '\n'
            distX=float(nkcxi)-float(offsetkcxi)
            distX=("%.4f" % distX)
            distY=float(nkcyi)-float(offsetkcyi)
            distY=("%.4f" % distY)
            programa=programa + "G01 X-" + str(distX) + ' Y' + str(distY) + '\n'
            ...
            if mx==1:
                ...
                distX=float(entrada)+float(nkcxi)+float(offsetkcxi)
                distX=("%.4f" % distX)
                distY=float(nkcyi)-float(offsetkcyi)
                distY=("%.4f" % distY)
                programa=programa + "G00 X" + str(distX) + ' Y' + str(distY) + '\n'
            ...
            distX=float(nktxi)-float(entrada)+float(offsetkcxi)
            distX=("%.4f" % distX)
            distY=float(offsetkcyi)
            distY=("%.4f" % distY)
            programa=programa + "G00 X" + str(distX) + ' Y' + str(distY) + '\n'
