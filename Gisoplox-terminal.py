...
def formatos(processo):
    ...
    if ferramenta=="1":
        ...
        espi=input("Espessura:")
        txd=input("Tamanho X:")
        tyd=input("Tamanho Y:")
        entrada=input("Entrada:")
        chapaX=input("Tamanho da chapa em X:")
        chapaY=input("Tamanho da chapa em Y:")
        pecas=input("Quantidade:")
        ...
        cliente=cliente.upper()
        espi=input("Espessura:")
        diam1=input("Diâmetro 1:")
        diam2=input("Diâmetro 2:")
        entrada=input("Entrada:")
        chapaX=input("Tamanho da chapa em X:")
        chapaY=input("Tamanho da chapa em Y:")
        pecas=input("Quantidade:")
